...
void KeyValueCountingBloomFilterTest::testDiff() {
	bloom::KeyValueCountingBloomFilter FilterA(hashFunction_, *storage1, "",
			8196);
	bloom::KeyValueCountingBloomFilter FilterB(hashFunction_, *storage2, "",
			8196);
...
void KeyValueCountingBloomFilterTest::testToString() {
	bloom::KeyValueCountingBloomFilter
			FilterA(hashFunction_, *storage1, "", 10);
	bloom::KeyValueCountingBloomFilter
			FilterB(hashFunction_, *storage2, "", 10);
